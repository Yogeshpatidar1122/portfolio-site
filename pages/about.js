...
export default function About() {
  return (
    <Layout metaTitle="About Me - Yogesh Patidar">
      <>
        <section className="w-11/12 mx-auto mt-6 mb-12 sm:w-5/6 lg:w-2/3 xl:w-[54rem]">
          ...
          <div className="mt-6 leading-7">
            <p className="mb-6">
              Hi, I&#39;m Yogesh Patidar. I&#39;m a front-end web developer from
              India. I enjoy seeking out creative solutions to complex problems.
              It was back in late 2023 when I got interested in Web Development
            ...
            <p className="mb-6">
              ...
              <a
                href="mailto:yogeshpatidar340@gmail.com"
                rel="noreferrer"
                target="_blank"
                className="text-green underline font-medium dark:text-mustard"
              >
                yogeshpatidar340@gmail.com
              </a>
            </p>
          </div>
          <Skills />
